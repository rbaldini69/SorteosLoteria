Public Class poceada
    Private Sub poseada_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GroupBox1_Enter(sender As Object, e As EventArgs) Handles grbPoceada.Enter
    ...
    Private Sub lblOrden18_Click(sender As Object, e As EventArgs) Handles lblOrden18.Click

    End Sub

    Private Sub lblOrden17_Click(sender As Object, e As EventArgs) Handles lblOrden17.Click
